    ...
    <div id="slide"class="sidebar ">
            ...
            <ul class="menu d-flex flex-column">
                ...
                if($auth === 0){
                    ...
                    <li><a class="active" href="manage_users.php"><i class="fas fa-users"></i>Správa uživatelů</a></li>
        ...
        <div class="ecard mb-3">
            <div class="ecard-body">
                <div class="d-flex flex-sm-row flex-column align-items-sm-baseline  justify-content-sm-between align-items-center">
                    <div class="card_title"><h1>Správa uživatelů</h1></div>
                   </div>
            </div>
        </div>
        <div class="ecard ">
            <div class="ecard-body">
                 <div class="search-filter row mb-5 ">
                    ...
                    <input type="text" id="blogSearch" placeholder="Najít uživatele...">
                    </div>
                ...
                <div class="manage_blogs_header ">
                    <div class="row">
                        ...
                        <div class="col col-lg-3 col-md-4 col-12"><label for="">Email</label></div>
